...
#
# The ORIGINAL phone app, kept at /jw-classic as a way back while the React
# rebuild (now at /jw) beds in. Nothing new is built here.
#
...
def _build():
	...
	try:
		return str(int(os.path.getmtime(os.path.join(os.path.dirname(__file__), "jw_classic.html"))))[-6:]
	except OSError:
		return "?"
