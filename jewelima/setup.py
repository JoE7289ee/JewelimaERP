...
JEWELIMA_REPAIR_PAGES = ["repair-quick-check", "new-repair-order", "repair-status",
	"repair-billing", "repair-dispatch", "repair-kpi", "repair-masters"]
JEWELIMA_REPAIR_DOCTYPES = ["Repair Order", "Repair Order Item", "Repair Party",
	...
	"Repair Dispatch Note", "Repair Dispatch Item", "Repair Work Line"]
...
def setup_roles():
	...
	for _pg in ("training-videos", "my-account", "request-feature", "quick-menu-setup"):
