...
(() => {
	const RESET_PAGES = new Set([
		"place-order", "ws-ordering", "purchase-raw-material", "meeting-minutes", "melt-gold", "job-work", "assign-collect", "bag-split", "transfer-order-bag", "multi-barcode", "print-barcode", "stock-transfer", "make-products", "card-info", "design-info", "design-report", "job-order-status", "retire-design", "design-gallery", "design-tags", "design-types", "order-masters", "warehouse-management", "print-order-bags", "order-bag-photos", "cad-jobs", "make-tree", "raw-materials", "party-stock", "party-metal", "order-requests", "all-requests", "gold-casting", "stock-analysis", "casting-queue", "casting-weigh", "in-bags", "import-stock", "finished-stock", "at-certification", "certify", "certification-out", "transfer-bucket", "transfer-holder", "sell", "old-format", "saved-imports", "party-gold", "party-groups", "bag-status", "buckets", "view-pc", "sales-records", "parties", "employee-loss", "loss-history", "loss-report", "loss-collection", "loss-writeoff", "user-roles", "add-user", "reset-password", "quick-menu-setup", "cancellation", "purchase-history", "add-employee", "stone-issue", "stone-issues", "stone-history", "due-view", "photo-queue", "request-feature", "stone-audit", "repack-stock", "stone-repack-history", "stone-adjustment", "stone-adjustment-history", "usage", "select-photos", "selected-pieces", "photo-update", "photo-urgent", "customer-photos", "customer-update", "photo-kpi", "photo-approvals", "rejection", "melt-history", "my-account", "assign-bench", "add-findings", "findings-history", "findings-stock", "issue-findings", "findings-report", "location-stock", "total-gold", "recover-findings", "rework", "finished-goods",
	]);
	let last = null;
