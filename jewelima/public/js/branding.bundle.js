...
(() => {
	const JW_PAGES = ["add-employee", "add-findings", "add-user", "all-requests", "assign-collect", "at-certification", "bag-split", "bag-status", "bench-info", "bench-work-setup", "cad-jobs", "cad-sheet", "cad-workstation", "cancellation", "card-builder", "card-info", "casting-queue", "casting-weigh", "certification-out", "certify", "confirm-certifications", "customer-photos", "customer-update", "delivery-masters", "design-bank-report", "design-duplicates", "design-gallery", "design-info", "design-report", "design-review", "design-tags", "design-types", "due-risk", "due-soon", "due-view", "dye-bank", "dye-find", "dye-info", "dye-manage", "edit-order", "employee-loss", "file-share", "findings-history", "findings-report", "findings-stock", "finished-goods", "finished-stock", "gold-casting", "import-stock", "in-bags", "issue-access", "issue-findings", "job-order-status", "job-work", "location-stock", "loss-collection", "loss-history", "loss-report", "loss-writeoff", "make-products", "make-tree", "meeting-minutes", "melt-gold", "melt-history", "migration-goals", "new-design-bank", "old-categories", "old-format", "order-bag-photos", "order-masters", "order-requests", "parties", "party-gold", "party-groups", "party-masters", "party-metal", "party-stock", "photo-approvals", "photo-kpi", "photo-queue", "photo-update", "photo-urgent", "place-order", "prepare-sale", "price-charts", "print-barcode", "print-order-bags", "prioritization", "purchase-history", "purchase-masters", "purchase-raw-material", "quick-menu-setup", "raw-materials", "recover-findings", "rejection", "repack-requests", "repack-stock", "repair-bills", "repair-desk", "repair-intake", "repair-setup", "request-feature", "reset-password", "retire-design", "retired-designs", "rework", "role-access", "sales-records", "saved-imports", "search-design", "select-photos", "selected-pieces", "selection-providers", "selection-review", "selection-tags", "sell", "sell-old", "send-certifications", "sieve-chart", "stock-analysis", "stock-transfer", "stone-audit", "stone-history", "stone-info", "stone-issue", "stone-issues", "stone-request", "stone-return", "stone-stock", "system-information", "total-gold", "transfer-holder", "transfer-matrix", "transfer-order-bag", "usage", "user-roles", "view-pc", "warehouse-management", "weight-checker", "ws-bag-extraction", "ws-cad-ws", "ws-cam", "ws-filing", "ws-final-polish", "ws-grinding", "ws-ordering", "ws-pre-polish", "ws-setting", "ws-wax-cleaning", "ws-wax-setting", "ws-waxing"];
	const st = document.createElement("style");
...
(() => {
	const RESET_PAGES = new Set([
		"place-order", "ws-ordering", "purchase-raw-material", "meeting-minutes", "melt-gold", "job-work", "assign-collect", "bag-split", "transfer-order-bag", "print-barcode", "stock-transfer", "make-products", "card-info", "design-info", "design-report", "job-order-status", "retire-design", "design-gallery", "design-tags", "design-types", "order-masters", "warehouse-management", "print-order-bags", "order-bag-photos", "cad-jobs", "make-tree", "raw-materials", "party-stock", "party-metal", "order-requests", "all-requests", "gold-casting", "stock-analysis", "casting-queue", "casting-weigh", "in-bags", "import-stock", "finished-stock", "at-certification", "certify", "certification-out", "transfer-holder", "sell", "sell-old", "old-format", "saved-imports", "party-gold", "party-groups", "bag-status", "view-pc", "sales-records", "parties", "employee-loss", "loss-history", "loss-report", "loss-collection", "loss-writeoff", "user-roles", "add-user", "reset-password", "quick-menu-setup", "repair-intake", "repair-desk", "repair-bills", "repair-setup", "cancellation", "purchase-history", "add-employee", "stone-issue", "stone-issues", "stone-history", "due-view", "photo-queue", "request-feature", "stone-audit", "repack-stock", "repack-requests", "usage", "select-photos", "selected-pieces", "photo-update", "photo-urgent", "customer-photos", "customer-update", "photo-kpi", "photo-approvals", "rejection", "melt-history", "migration-goals", "my-account", "assign-bench", "add-findings", "findings-history", "findings-stock", "issue-findings", "findings-report", "location-stock", "total-gold", "recover-findings", "rework", "finished-goods",
	]);
	let last = null;
