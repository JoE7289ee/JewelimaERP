...
(() => {
	const RESET_PAGES = new Set([
		...
		"cad-jobs", "make-tree", "raw-materials", "stone-buckets", "party-stock", "party-metal", "order-requests", "all-requests", "gold-casting", "stock-analysis", "casting-queue", "casting-weigh", "in-bags", "import-stock", "finished-stock", "at-certification", "certify", "certification-out", "transfer-holder", "sell", "sell-old", "old-format", "saved-imports", "party-gold", "party-groups", "bag-status", "view-pc", "sales-records", "parties", "loss-report", "loss-collection", "loss-writeoff", "user-roles", "add-user", "reset-password", "quick-menu-setup", "repair-intake", "repair-desk", "repair-bills", "repair-setup", "cancellation", "purchase-history", "add-employee", "stone-issue", "stone-issues", "stone-history", "due-view", "photo-queue", "stone-audit", "repack-stock", "repack-requests", "usage", "day-sheet", "select-photos", "selected-pieces", "bench-cad", "bench-cam", "bench-wax-injecting", "bench-tree-making", "bench-casting", "bench-grinding", "bench-filing", "bench-setting", "bench-pre-polish", "bench-wax-setting", "bench-final-polish", "bench-wax-cleaning", "bench-bag-extraction",
		"item-stock",
	]);
	let last = null;
